...
# Simulation 1: Binary $y_1$, n = 1000 with no repeated observations, unstratified population
```{r sim1, cache = T, eval=F}
...
resFile <- '../results/sim1_binY1.RData'
...
# Simulation 2: Binary $y_1$, n = 500 with two repeated observations, unstratified population
```{r sim2, cache = T, eval=F}
...
resFile <- '../results/sim2_binY1.RData'
if(!file.exists(resFile)){
  grid <- expand.grid(n = as.integer(vals_n), sim = vals_sim, h2_add_t1 = h2_add_t1, h2_add_t2 = h2_add_t2, h2_cov = h2_cov, rhog = rhog, e_cov = e_cov)
  grid <- grid[grid$h2_cov + grid$h2_add_t2 + grid$e_cov < 1, ]
...
# Simulation 3: Binary $y_1$, n = 333 with three repeated observations, unstratified population
```{r sim3, cache = T, eval=F}
...
resFile <- '../results/sim3_binY1.RData'
if(!file.exists(resFile)){
  grid <- expand.grid(n = as.integer(vals_n), sim = vals_sim, h2_add_t1 = h2_add_t1, h2_add_t2 = h2_add_t2, h2_cov = h2_cov, rhog = rhog, e_cov = e_cov)
  grid <- grid[grid$h2_cov + grid$h2_add_t2 + grid$e_cov < 1, ]
...
# Simulation 4: Binary $y_1$, n = 250 with four repeated observations, unstratified population
```{r sim4, cache = T, eval=F}
...
resFile <- '../results/sim4_binY1.RData'
if(!file.exists(resFile)){
  grid <- expand.grid(n = as.integer(vals_n), sim = vals_sim, h2_add_t1 = h2_add_t1, h2_add_t2 = h2_add_t2, h2_cov = h2_cov, rhog = rhog, e_cov = e_cov)
  grid <- grid[grid$h2_cov + grid$h2_add_t2 + grid$e_cov < 1, ]
